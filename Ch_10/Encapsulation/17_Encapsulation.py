...
# 2. Private Members: These members are accessible only within the class and its members.
# Syntax: self.__attribute_name

# 3. Protected Members: These members are accessible within the class and its derived classes.
# Syntax: self._attribute_name
...
# Private : accessible only within the class and its members
